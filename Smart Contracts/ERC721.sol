...
contract FILTECH is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    // internal function to reurn base uri of token
    function _baseURI() internal view virtual override returns (string memory) {
        return baseURI;
    }

    // public function provides the functionality to mint any no of tokens
    ...
    //function that will return the tokenids for the tokens available in walletOfOwner
    ...
    //function returns the tokenURI of specific token on the basis of tokenid
    function tokenURI(uint256 tokenId)
        public
        view
        virtual
    ...
    //only owner 
    //function to set the cost of token
    function setCost(uint256 _newCost) public onlyOwner {
        cost = _newCost;
    }
    
    //function to set a cost of the token before sale
    function setPresaleCost(uint256 _newCost) public onlyOwner {
        presaleCost = _newCost;
    }
    
    //function to restrict the maximum minting of no of tokens 
    function setmaxMintAmount(uint256 _newmaxMintAmount) public onlyOwner {
        maxMintAmount = _newmaxMintAmount;
    }

    //function to set the base uri of nft 
    function setBaseURI(string memory _newBaseURI) public onlyOwner {
        baseURI = _newBaseURI;
    }

    //function used to set baseExtension of nft 
    ...
    //function that allows the owner to create a whitelist of addresses
    function whitelistUser(address _user) public onlyOwner {
        whitelisted[_user] = true;
    }

    //function that allows the owner to remove a whitelist of addresses
    function removeWhitelistUser(address _user) public onlyOwner {
        whitelisted[_user] = false;
    }

    //function to add presaleuser 
    function addPresaleUser(address _user) public onlyOwner {
        presaleWallets[_user] = true;
    }
    
    //function to add 100 presale users
    ...
    //function to remove a presale user
    function removePresaleUser(address _user) public onlyOwner {
        presaleWallets[_user] = false;
    }

   //function to Withdraw Earnings from an NFT Smart Contract
