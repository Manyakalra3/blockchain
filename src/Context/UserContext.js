...
// User context. all user related information is stored here.
...
const UserContextProvider = ({children}) => {
    ...
    // Sends a request to server to get information related to BTC in account.
    const getBTC = async () => {
    ...
    // Sends a request to server to get information related to ETH in account.
    const getETH = async () => {
    ...
    // Sends a request to server to get information related to XRP in account.    
    const getXRP = async () => {
    ...
    // Sends a request to server to get information related to Ethreum based Tokens in account.
    const getTOK = async () => {
        // setLoading(true)
    ...
    // Sends a request to server to get information related to Ethreum based NFT in account.
    const getNFT = async () => {
        // setLoading(true)
    ...
    // Sends a request to server to get information related all blockchains in account.
    ...
    // Sends a request to server transfer crypto to another user (P2P transaction)
    ...
    // Sends a request to server transfer tokens to another user (P2P transaction)
    ...
    // Sends a request to server transfer nfts to another user (P2P transaction)
    ...
    // Sends a request to coinbase to get value of crypto in pounds.
    useEffect(() => {
